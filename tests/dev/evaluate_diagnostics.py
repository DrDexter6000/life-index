...
EXPECTED = {
    ...
    "KW02": {"min_found": 3, "relevant_top": ["团团", "尿片侠"]},
    ...
    "KW10": {"min_found": 1, "relevant_top": ["爸爸", "尿片侠"]},
    "NL01": {"min_found": 1, "relevant_top": ["健康"]},
    "NL02": {"min_found": 1, "relevant_top": []},  # Sleep time - no specific data
    "NL03": {"min_found": 1, "relevant_top": ["团团"]},
    "NL04": {"min_found": 1, "relevant_top": ["daughter", "团团", "尿片侠", "想念"]},
    ...
    "NL10": {"min_found": 1, "relevant_top": ["开心", "Star", "团团"]},
}
