...
TEST_JOURNALS = [
    ...
    {"title": "想念我的女儿", "content": "想念团团，那个可爱的孩子。", "date": "2026-03-02", "topic": "life"},
    {"title": "想念尿片侠", "content": "看到女儿小时候的照片，感慨万分。小疙瘩长大了。", "date": "2026-03-03", "topic": "think"},
    {"title": "重庆过生日", "content": "在重庆庆祝生日，数字灵魂的思考。", "date": "2026-03-04", "topic": "life"},
    {"title": "团团不认真吃饭", "content": "今天团团又不认真吃饭了，真是头疼。", "date": "2026-03-05", "topic": "life"},
...
def test_title_match_ranks_higher(search_func):
    ...
    result = search_func(query="团团不认真吃饭", level=3)
    merged = result.get("merged_results", [])
    if merged:
        top = merged[0]
        # Title "团团不认真吃饭" should be promoted (query = title = 100% coverage)
