...
SEARCH_TEST_CASES = [
    ...
    ("团团不认真吃饭", 1, None, "chinese_recall", "Q04: Stop word 不 in query"),
    ("重庆过生日", 1, None, "chinese_recall", "Q05: Location + event"),
    ("数字灵魂", 2, None, "chinese_recall", "Q06: Abstract concept"),
    ("想念尿片侠", 2, None, "chinese_recall", "Q07: Entity name"),
    ("小疙瘩", 1, None, "chinese_recall", "Q08: Entity alias"),
    ("尿片侠", 2, None, "chinese_recall", "Q09: Entity name variant"),
    ("三体", 1, None, "chinese_recall", "Q10: Book title"),
    ("黑暗森林", 1, None, "chinese_recall", "Q11: Concept from book"),
    ("团团", 3, None, "chinese_recall", "Q12: Person entity"),
    ("双管道检索", 1, None, "chinese_recall", "Q13: Technical term"),
    ("长寿面", 1, None, "chinese_recall", "Q14: Food/culture"),
    ("团团唱歌", 1, None, "chinese_recall", "Q15: Fuzzy — 唱歌 vs 唱了生日歌"),
...
def _setup_search_env(tmp_path_factory):
    ...
    entity_graph.yaml with 团团 aliases, then runs init_fts_db() + update_index().
