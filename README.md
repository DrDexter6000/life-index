...
> · **当前实测**：20+ CLI 命令 · 4,200+ pytest-collected tests · 108-query keyword-only Recall@5 = **0.9231**（2026-06-28 golden set；semantic/vector RAG 无四位小数增益）· 2026-05-25 完整 integrity audit PASS
