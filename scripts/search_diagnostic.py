...
KEYWORD_QUERIES = [
    {"id": "KW01", "query": "乐乐", "type": "keyword", "intent": "实体搜索 - 找到关于女儿乐乐的所有日志"},
    ...
    {"id": "KW07", "query": "小英雄", "type": "keyword", "intent": "实体别名搜索"},
...
NL_QUERIES = [
    ...
    {"id": "NL04", "query": "我和女儿之间有哪些珍贵的回忆？", "type": "nl", "intent": "关系+情感搜索 - 应找到乐乐相关"},
    {"id": "NL05", "query": "上个月在工作中取得了什么进展？", "type": "nl", "intent": "时间+工作维度搜索"},
    {"id": "NL06", "query": "missing my daughter", "type": "nl", "intent": "跨语言搜索 - 应找到想念小英雄"},
